namespace AntiqueBookstore.Domain.Entities
{
    ...
    {
        // TODO: Review approach: string (per-column) vs. Collection/JSON (snapshot)

        // Column based logging 
        public long EventId { get; set; } // Named PK
        // EventId data type should be long (int64) for large tables instead of int (int32)
